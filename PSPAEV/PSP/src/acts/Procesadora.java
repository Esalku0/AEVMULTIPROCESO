...
public class Procesadora {
	...
	public static void main(String[] args) {
		...
		// Asignamos las cantidades de las croquetas recibiendo los parametros por
		// argumento
		...
		try {
			...
			if (num1 > 0) {
				...
				if (num1 % 6 == 0 && num1 >= 6) {
					...
					JOptionPane.showMessageDialog(null, "Tiene que ser paquetes de 6 croquetas de Jamon");
				}
			}
			if (num2 > 0) {
				if (num2 % 6 == 0 && num2 >= 6) {
					...
					JOptionPane.showMessageDialog(null, "Tiene que ser paquetes de 6 croquetas de Pollo");
				}
			}
			...
			if (num3 > 0) {
				if (num3 % 6 == 0 && num3 >= 6) {
					...
					JOptionPane.showMessageDialog(null, "Tiene que ser paquetes de 6 croquetas de Bacalao");
				}
			}
			if (num4 > 0) {
				if (num4 % 6 == 0 && num4 >= 6) {
					...
					JOptionPane.showMessageDialog(null, "Tiene que ser paquetes de 6 croquetas de Queso");
				}
			}
		} catch (Exception e) {
			e.printStackTrace();
	...
	/**
	 * Este metodo nos sirve para comprobar el limite de croquetas para el apartado
	 * de limitar a 100 croquetas No utilizamos este metodo ya que no sabia como
	 * implementarlo.
	 * 
	 * @param cant Es la cantidad de croquetas actuales en cocinado
	 */
	public static void comprobarLimite(int cant) {
		if (cant == 100) {
			try {
