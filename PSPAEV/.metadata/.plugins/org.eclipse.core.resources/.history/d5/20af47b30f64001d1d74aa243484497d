...
public class Procesadora {
	...
	/**
	 * Este metodo nos sirve para comprobar el limite de croquetas para el apartado de limitar a 100 croquetas
	 * No utilizamos este metodo ya que no sabia como implementarlo.
